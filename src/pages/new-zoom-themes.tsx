...
const zoomIntro =
  "Think you've got a fun Zoom background for your team? Submit it here!"
const sucessfulSubmitMessage =
  'Your background idea has been submitted. If approved it will appear in #dmv-social'
